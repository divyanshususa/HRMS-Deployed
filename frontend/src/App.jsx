...
import Form16Component from './components/tesiing';
import Form16 from './components/Taxtationoverview';
import UploadTaxOverview from "./components/uploadTaxOverview";
    ...
    <>
      <Router>
        <Routes>
          ...
          <Route path="/formet" element={<Form16Component />} />
          ...
          <Route
            path="/employee"
            element={<EmployeeProtectRoute Component={MainLayout} />}
          >
            ...
            <Route
              path="/employee/payslip/created-payslip/:employeeId/:month/:year"
              element={<PaySlip />}
            />
          ...
          <Route
            path="/hr"
            element={<HrProtectRoutes Component={MainLayout} />}
          >
            {/* <Route index element={<Dashbaord />} /> */}
            <Route index element={<ProfileView />} />
            ...
            <Route
              path="/hr/payslip/created-payslip/:employeeId/:month/:year"
              element={<PaySlip />}
            />
          ...
          <Route
            path="/manager"
            element={<ManagerProtectRout Component={MainLayout} />}
          >
            <Route index element={<ProfileView />} />
            {/* <Route index element={<Dashbaord />} /> */}
            ...
            <Route
              path="/manager/payslip/created-payslip/:employeeId/:month/:year"
              element={<PaySlip />}
            />
            ...
            <Route
              path="/manager/projects/create-project"
              element={<CreateProject />}
            />
            <Route
              path="/manager/leaves-request"
              element={<LeaveUnderManager />}
            />
          </Route>

          <Route
            path="/admin"
            element={<AdminProtectRoutes Component={MainLayout} />}
          >
            <Route index element={<Dashbaord />} />
            ...
            <Route
              path="/admin/staff/staff-profile/:employeeId"
              element={<EmpProfile />}
            />
            <Route path="/admin/staff/add-staff" element={<AddStaffForm />} />
            <Route
              path="/admin/paymentvoucher"
              element={<PaymentVoucherTable />}
            />
            <Route
              path="/admin/paymentvoucher/create"
              element={<CreatePaymentVoucher />}
            />
            <Route path="/admin/payroll" element={<Payroll />} />
            <Route
              path="/admin/payroll/salary-defination"
              element={<SalaryDefination />}
            />
            <Route
              path="/admin/payroll/tax-defination"
              element={<TaxDefination />}
            />
            <Route
              path="/admin/payroll/create-payslip"
              element={<CreatePayslip setpayslip={setpayslip} />}
            />
            <Route
              path="/admin/payroll/created-payslip/:employeeId/:month/:year"
              element={<PaySlip payslip={payslip} />}
            />
            <Route
            ...
            <Route
              path="/admin/circular/create-circular"
              element={<CreateCircular />}
            />
            <Route path="/admin/logistics" element={<Logistics />} />
            <Route
              path="/admin/logistic/logistic-request"
              element={<LogisticRequest />}
            />
            <Route path="/admin/budget" element={<OfficeBudget />} />
            <Route
              path="/admin/budget/create-budget"
            ...
            <Route
              path="/admin/capacity/training-request"
              element={<TrainingRequest />}
            />
            <Route path="/admin/procurement" element={<Procurement />} />
            <Route
              path="/admin/procurement/procurement-request"
              element={<ProcurementReq />}
            />
            ...
            <Route path="/admin/form16" element={<Form16 />} />
            <Route
              path="/admin/uploadTaxOverview"
              element={<UploadTaxOverview />}
            />
          </Route>
        </Routes>
      </Router>
